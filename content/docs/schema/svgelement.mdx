---
title: SVGElement
description: Documentation for the SVGElement schema definition in the Polotno Design JSON Schema.
keywords: ["SVGElement", "JSON Schema", "Polotno", "Design", "API", "Documentation"]
---
...
| `colorsReplace` | `object` | Color replacement mappings. |
...
| `flipX` | `boolean` | Whether SVG is flipped horizontally. |
| `flipY` | `boolean` | Whether SVG is flipped vertically. |
...
| `maskSrc` | `string` | URL or data URI for SVG mask. |
...
| `src` | `string` | URL or data URI of the SVG file. |
