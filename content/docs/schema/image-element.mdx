---
title: ImageElement
description: Documentation for the ImageElement schema definition in the Polotno Design JSON Schema.
keywords: ["ImageElement", "JSON Schema", "Polotno", "Design", "API", "Documentation"]
---
