---
title: GifElement
description: Documentation for the GifElement schema definition in the Polotno Design JSON Schema.
keywords: ["GifElement", "JSON Schema", "Polotno", "Design", "API", "Documentation"]
---
...
| `duration` | `number` | GIF duration in milliseconds. |
