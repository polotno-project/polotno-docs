...
Show or hide distance guides on workspace. Distance guides appear when a user selects element and hold ALT to show distances to nearby elements.
The property allows to force show distance even if user didn't hold ALT.
