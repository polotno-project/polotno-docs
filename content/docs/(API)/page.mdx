...
See also: [docs](https://developer.polotno.com/docs/page-overview#pagesetattrs)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pagesetsize-width-height-usemagic-)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pageaddelementattrs)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pageclone)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pagesetzindexindex)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pagechildren)
...
See also: [docs](https://developer.polotno.com/docs/page-overview#pagecomputedwidth)

## page.computedHeight

Return height of the page in pixels.

See also: [docs](https://developer.polotno.com/docs/page-overview#pagecomputedheight)
