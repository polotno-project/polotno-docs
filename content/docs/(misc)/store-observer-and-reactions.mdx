...
Polotno has a rich [store API](https://polotno.com/docs/store-overview) that you can use to observe and control canvas content. The store object is created using the MobX library. You can use MobX utilities to build reactive components.
