...
- **htmlTextRenderEnabled**: boolean — enable [Rich Text](https://developer.polotno.com/docs/rich-text/) rendering for text elements (default: false).
- **textVerticalResizeEnabled**: boolean — enable [Vertically Resized Text](https://developer.polotno.com/docs/vertical-text-resize/) (default: false).
...
- **textOverflow**: string — overwrite [text overflow](https://polotno.com/docs/text-overflow) logic. Default: `change-font-size`. Other values: `resize`, `ellipsis`.
...
<Sandbox github="polotno-project/polotno-site/tree/source/examples/polotno-cloud-render" />
