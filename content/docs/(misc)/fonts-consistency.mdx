...
<Callout type="info">
This page covers **rendering consistency** issues. For general font configuration (adding fonts, Google Fonts, etc.), see the [Fonts guide](/docs/fonts).
</Callout>

<Callout type="note">
Polotno renders text using the browser's native text rendering engine. Different browsers and operating systems may produce slightly different results. This guide covers best practices to minimize these differences.
</Callout>
