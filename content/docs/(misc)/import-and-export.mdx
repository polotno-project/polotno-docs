...
The JSON must follow Polotno's [store structure](https://polotno.com/docs/store-overview).
...
For a deep dive into available options for each export, see the [store documentation](https://polotno.com/docs/store-overview).
...
Export to MP4 is available via the [Cloud Render API](https://polotno.com/docs/cloud-render) (not in the browser). Use MP4 for video content in marketing, social, and more.
