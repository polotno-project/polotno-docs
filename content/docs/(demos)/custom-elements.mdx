...
**Important:** this is an experimental feature, please proceed with caution. We're kindly asking you to report any bugs and follow the [changelog](https://developer.polotno.com/changelog) for the most recent updates.
...
1. Custom elements are not supported in [Cloud Render API](https://developer.polotno.com/docs/cloud-render).
2. By default [polotno-node](https://developer.polotno.com/docs/server-side) (for backend rendering) does not support custom elements. But with some [extra configuration](https://github.com/polotno-project/polotno-node#your-own-client) you can make it work.
