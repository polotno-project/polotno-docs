...
- Manual Button: Instead of automatically triggering the file input, you can display a button in the [Toolbar](https://polotno.com/docs/toolbar) or [Tooltip](https://polotno.com/docs/tooltip). Clicking it would open the same file dialog.
...
<Sandbox github="polotno-project/polotno-site/tree/source/examples/polotno-select-image-placeholder" />
