...
You can use **Polotno** tools and side panel customization to make your own library of templates.
...
5. If you skipped step 3 you can use [Cloud Render API](https://polotno.com/cloud-render) to generate previews automatically
...
You can use the [Polotno Cloud API](https://developer.polotno.com/docs/cloud-render) to generate previews with your own backend language.
...
As soon as you have a backend API to get a list of templates, you can use [Side Panel Customization](https://developer.polotno.com/docs/side-panel) to display that list on the page. In the demo we will use `<ImagesGrid />` and the `useInfiniteAPI` hook ([docs](https://developer.polotno.com/docs/side-panel-utils)). You don't have to use them in your app, but they can save time for this use case.
...
<Sandbox github="polotno-project/polotno-site/tree/source/examples/polotno-templates-library" />
