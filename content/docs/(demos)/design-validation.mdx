...
You can use the [Store API](https://polotno.com/docs/store-overview) to inspect each element's properties on the page, enabling thorough design checks and validation to custom standards. Define your own validation logic and display it however best fits your use case.
