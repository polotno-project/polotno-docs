...
If you want to add/remove fonts specific to the user, use the [Store Fonts API](/docs/store#working-with-fonts).
...
To remove a specific global font:
...
To replace all global fonts at once:
