...
Currently, the **Timeline** component is not customizable. However, you can remove it and implement your own version using the [Store API](/docs/store-overview).
...
You can also use [CSS to overwrite](/docs/theme) and customize the general styles of the editor.
...
The [Store API](/docs/store-overview) allows you to implement all of these features, ensuring your data flow fits seamlessly with your infrastructure.
