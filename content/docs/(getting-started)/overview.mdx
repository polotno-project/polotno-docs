...
<Accordions type="single">
  <Accordion title="CSS Scoping (Optional)">

If you need to isolate Polotno styles from your application's global CSS, use the scoped CSS variant.

**Step 1**: Replace regular Blueprint CSS with the scoped version:
...
**Step 2**: Add `bp5-scope` class to any Polotno container:
...
**Live example**: [CSS Scoping Demo](https://codesandbox.io/p/sandbox/serene-water-x4ztyl)

This approach prevents Polotno's Blueprint styles from affecting your application's UI and vice versa. Useful when integrating Polotno into existing applications with their own design systems.
