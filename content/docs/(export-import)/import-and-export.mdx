...
description: Overview of Polotno's import (JSON, SVG) and export (PNG, JPEG, PDF, PPTX, HTML, SVG, GIF, MP4) options
---
...
**Import:** JSON (open, developer-friendly format), [SVG](/docs/svg-import), [PDF](/docs/pdf-import)
