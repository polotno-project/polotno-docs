...
export default function App() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', gap: '8px' }}>
      <div style={{ padding: '12px', display: 'flex', gap: '12px' }}>
        <button style={buttonStyle(layout === 'vertical')} onClick={() => setLayout('vertical')}>
          Vertical
        </button>
        <button style={buttonStyle(layout === 'horizontal')} onClick={() => setLayout('horizontal')}>
          Horizontal
        </button>
      </div>
