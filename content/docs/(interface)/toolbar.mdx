...
Following [Custom Element Example](https://developer.polotno.com/docs/custom-element), you can make your own React component for any available element.
...
<Sandbox github="polotno-project/polotno-site/tree/source/examples/polotno-toolbar-actions" />
