---
title: Toolbar
description: UI component to edit elements, align/reorder, and handle undo/redo
---
...
table element:
  ...
  CellBackground
  TableStructure
  TextFontFamily (when cells focused)
  TextFontSize (when cells focused)
  TextFill (when cells focused)
  TextFontVariant (when cells focused)
  CellVerticalAlign (when cells focused)
  TextSpacing (when cells focused)
  TableAnimations
...
Following [Custom Element Example](/docs/custom-elements), you can make your own React component for any available element.
...
<Sandbox github="polotno-project/polotno-docs/tree/main/examples/polotno-toolbar-actions" />
