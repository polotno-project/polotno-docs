...
description: Build your own Sizes panel with presets and unit-aware inputs
---
...
<Sandbox github="polotno-project/polotno-site/tree/source/examples/polotno-resize-panel" />
